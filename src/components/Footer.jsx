      ...
      <div style={{padding:'30px'}} className='container mt-5 w-100 '>
        <div className='d-lg-flex justify-content-between align-items-between'>
          ...
          <Link
            ...
            >
              <i className="fa-solid fa-cart-plus "></i>Project Fair
            </Link>
          ...
          <div className='contact'>
            ...
            <div className='d-flex'>
              <input type="text" placeholder='Email id please' style={{ borderRadius: '10px', padding: '5px',border:'1px solid white',background:'transparent',color:'white' }} />
            ...
            <div className='d-flex mt-3 justify-content-between '>
              ...
              <a href=""><i className="fa-brands fa-x-twitter text-light"></i></a>
              ...
              <a href=""><i className="fa-solid fa-phone text-light"></i></a>
        ...
        <p className='text-center mt-5 text-light'>Copyright © 2024 Project Fair. Built with React.</p>
